...
public class Level3 {
    ...
    public static void main(String[] args) {
        ...
        String names = teachers.stream().map(Teacher::getName).map(String::toUpperCase).reduce((name1,name2)->name1.concat("#").concat(name2)).orElse("");

        /* TO DO 2: Retourner une set d'enseignants Java dont le salaire > 80000 */
        Set<Teacher> teachers1 = teachers.stream().filter(teacher -> teacher.getSubject().equals("Java")&& teacher.getSalary()>80000).collect(Collectors.toSet());
